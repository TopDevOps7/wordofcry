<template>
  <div class="swiper-pagination">
    <a class="header-logo" href="/"
      ><img src="../assets/1110z1/images/logo_1.png"
    /></a>
    <!-- H5 端 header START -->
    <div class="header-nav">
      ...
      <div class="nav-text">
        <span
          v-bind:class="{
            'have-child-after': activeIndex === 0,
            'have-child-before': activeIndex !== 0,
          }"
          @click="onNavClick(0)"
          >CRYPTOIDS
        </span>
      ...
      <div class="nav-text">
        <span
          v-bind:class="{
            'have-child-after': activeIndex === 1,
            'have-child-before': activeIndex !== 1,
          }"
          @click="onNavClick(1)"
          >GAME INFO
        </span>
        <div v-bind:class="{ active: activeIndex === 1 }" class="children">
          <router-link
            @click.native="onLinkClick"
            class="text-span"
            to="/sp2e#section-sp2e"
            >sP2E</router-link
          >
          <router-link
            @click.native="onLinkClick"
            class="text-span"
            to="/sp2e#section-tokenomics"
          ...
          <router-link
            @click.native="onLinkClick"
            class="text-span"
            to="/sp2e#section-guild"
            >Guild & Scholarship</router-link
          >
        </div>
      </div>
      <div class="nav-text">
        <span
          v-bind:class="{
            'have-child-after': activeIndex === 2,
            'have-child-before': activeIndex !== 2,
          }"
          @click="onNavClick(2)"
      ...
      <div class="nav-text">
        <span
          v-bind:class="{
            'have-child-after': activeIndex === 3,
            'have-child-before': activeIndex !== 3,
          }"
          @click="onNavClick(3)"
          >MISC</span
        >
      ...
      <div class="nav-text">
        <a
          ...
          href="https://market.cryptoids.world/"
          >MARKETPLACE</a
        >
      </div>
      <!--<div class="nav-btn">-->
      ...
      <div class="nav-text share">
        <a href="https://bit.ly/3GXxiJd"
          ><img src="../assets/1110z1/images/Follow-us-10.png"
        /></a>
        <a href="https://bit.ly/3IGaMWG"
          ><img src="../assets/1110z1/images/Follow-us-7.png"
        /></a>
      </div>
      <div class="contract">
        <div>
          ...
          <div>
            ...
            <button
              class="copy"
              @click="
                copyCode('.copy', '0xF35aee66AB0D099aF233c1ab23E5f2138B0ED15B')
              "
            ></button>
          </div>
        </div>
        <div>
          ...
          <div>
            ...
            <button
              class="copy"
              @click="
                copyCode('.copy', '0x5B7D8a53E63F1817B68d40DC997cB7394dB0ff1a')
              "
            ></button>
          </div>
        </div>
    ...
    <div class="nav-container">
      <nav class="nav">
        <ul>
          ...
          <li>
            <a href="#" data-to="marketURL" target="_blank">MARKETPLACE</a>
          </li>
          <li>
            <a
    ...
    onLinkClick: function (index) {
      ...
      if (location.hash.length > 1) {
        document.querySelector("#contents").scrollTo({
          top: $(location.hash).position().top,
          behavior: "smooth",
        });
      }
    },
